export default {
  ...
  footer: {
    ...
    contact: 'צור קשר',
    linkTitle: 'ראשי',
    bodies: 'מכרזים לפי גופים',
    categories: 'מכרזים לפי קטגוריות',
    transport: 'מכרזי תחבורה',
    gov: 'מכרזי ממשלה',
    defence: 'מכרזי משרד הביטחון',
    minhal: 'מכרזי מנהל מקרקעי ישראל',
    education: 'מכרזי משרד החינוך',
    police: 'מכרזי משטרה',
    electricity: 'מכרזי חברת החשמל',
    country: 'מכרזי שירות המדינה',
    health: 'מכרזי משרד הבריאות',
    welfare: 'מכרזי משרד הרווחה',
    binuy: 'מכרזי משרד השיכון והבינוי',
    building: 'מכרזי בניה',
    land: 'מכרזי מקרקעין',
    assets: 'מכרזי נכסים',
    electricity2: 'מכרזי עבודות חשמל',
    drive: 'מכרזי הסעות',
    drive2: 'מכרזי רכב'
  }
}
