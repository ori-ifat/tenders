export default {
  ...
  login: {
    ...
    noSuchUser: 'הכתובת לא נמצאת במערכת, אנא פנה לשרות לקוחות 03-5635031/7',
    ...
    notRestored: 'חלה תקלה בתהליך השיחזור. אנא פנה לשרות לקוחות 03-5635031/7',
    tokenNotValid: 'פג תוקף הבקשה. יש לבקש שיחזור מחדש דרך "שכחתי סיסמא" במסך ההתחברות',
    badToken: 'הועבר מספר זיהוי לא תקין של הבקשה, או שחלה שגיאה אחרת. יש לפנות לשירות'
  },
  nav: {
